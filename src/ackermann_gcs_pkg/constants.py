...
# hdot_min物理合理默认值，确保时间缩放导数h'(s)不会过小
HDOT_MIN_DEFAULT: float = 0.01

# hdot_min过小警告阈值，低于此值可能引起速度/加速度数值不稳定
HDOT_MIN_WARNING_THRESHOLD: float = 0.001
